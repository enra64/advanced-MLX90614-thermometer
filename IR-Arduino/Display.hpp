...
U8G2_PCD8544_84X48_1_4W_SW_SPI display(U8G2_R2, SPI_CLOCK, SPI_DATA, SPI_CS_DISPLAY, SPI_DC, SPI_RESET);
...
void renderGraph(double *input, uint32_t count, double max, double min) {
...
void displayMeasurement(double *input, uint32_t count, bool continuousScanEnabled, bool backgroundLightEnabled,
                        bool laserEnabled) {
